  ...
  db.get('SELECT COUNT(*) AS count FROM opportunities', [], (err, row) => {
    if (!err && row && row.count === 0) {
      db.run(`
        ...
        ('Data Analyst Intern', 'Nazareth Student Analytics', 'Maya Yassin', 'intern1@nazstudent.co.il', '04-602-2001', 'Nazareth', 'internship', 'Support data analysis and reporting tasks.', 'open'),
        ...
        ('Inventory Analytics Project', 'Haifa Inventory Lab', 'Neta Ben Nun', 'project4@haifainventory.co.il', '04-603-3004', 'Haifa', 'project', 'Analyze stock and inventory data to improve planning.',('Data Analyst Intern", "Nazareth Student Analytics", "Maya Yassin", "intern1@nazstudent.co.il", "04-602-2001", "Nazareth", "internship", "Support data analysis and reporting tasks.", "open"),
        ("BI Intern", "Karmiel BI Lab", "Niv Bar", "intern2@karmielbi.co.il", "04-602-2002", "Karmiel", "internship", "Support dashboarding and KPI analysis.", "open"),
        ("ERP Intern", "Acre ERP Academy", "Roei Maman", "intern3@acreerp.co.il", "04-602-2003", "Acre", "internship", "Assist ERP process mapping and support activities.", "open"),
        ("QA Intern", "Tirat QA Center", "Sivan Ohana", "intern4@tiratqa.co.il", "04-602-2004", "Tirat Carmel", "internship", "Participate in testing and documentation.", "open"),
        ("Project Management Intern", "Afula PM Track", "Dean Tzuberi", "intern5@afulapm.co.il", "04-602-2005", "Afula", "internship", "Help track project timelines and action items.", "open"),
        ("CRM Optimization Project", "Nof CRM Projects", "Alaa Khateeb", "project1@nofcrm.co.il", "04-603-3001", "Nof HaGalil", "project", "Applied project for CRM workflow redesign and KPI tracking.", "open"),
        ("BI Dashboard Project", "Safed Dashboard Works", "Lihi Vaknin", "project2@safeddash.co.il", "04-603-3002", "Safed", "project", "Create a dashboard for operational and academic reporting.", "open"),
        ("ERP Process Mapping Project", "Bialik ERP Studio", "Elad Harari", "project3@bialikerp.co.il", "04-603-3003", "Kiryat Bialik", "project", "Map ERP-related business processes and recommend improvements.",("Data Analyst Intern"), ("Nazareth Student Analytics"), ("Maya Yassin"), ("intern1@nazstudent.co.il"), ("04-602-2001"), ("Nazareth"), ("internship"), ("Support data analysis and reporting tasks."), ("open")),
        (("BI Intern"), ("Karmiel BI Lab"), ("Niv Bar"), ("intern2@karmielbi.co.il"), ("04-6₀₂₋₂₀₀₂"), ("Karmiel"), ("internship"), ("Support dashboarding and KPI analysis."), ("open")),
        (("ERP Intern"), ("Acre ERP Academy"), ("Roei Maman"), ("intern3@acreerp.co.il"), ("₀₄₋₆₀₂₋₂₀₀₃"), ("Acre"), ("internship"), ("Assist ERP process mapping and support activities."), ("open")),
        (("QA Intern"), ("Tirat QA Center"), ("Sivan Ohana"), ("intern4@tiratqa.co.il"), ("₀₄₋₆₀₂₋₂₀₀₄"), ("Tirat Carmel"), ("internship"), ("Participate in testing and documentation."), ("open")),
        (("Project Management Intern"), (“Afula PM Track”), (“Dean Tzuberi”), (“intern5@afulapm.co.il”), (“₀₄₋₆₀₂₋₂₀₀₅”), (“Afula”), (“internship”), (“Help track project timelines and action items.”), (“open”)),
        (("CRM Optimization Project"), ("Nof CRM Projects"), ("Alaa Khateeb"), ("project1@nofcrm.co.il"), ("₀₄₋₆₀₃₋₃₀₀₁"), ("Nof HaGalil"), ("project"), ("Applied project for CRM workflow redesign and KPI tracking."), ("open")),
        (("BI Dashboard Project"), ("Safed Dashboard Works"), ("Lihi Vaknin"), ("project2@safeddash.co.il"), ("₀₄₋₆₀₃₋₃₀₀₂"), ("Safed"), ("project"), ("Create a dashboard for operational and academic reporting."), ("open")),
        ('ERP Process Mapping Project', 'Bialik ERP Studio', 'Elad Harari', 'project3@bialikerp.co.il', '04-603-3003', 'Kiryat Bialik', 'project', 'Map ERP-related business processes and recommend improvements.', 'open'),
...
('מוחמד אבו זייד בע"מ – מאטין אלומיניום', 'פתרונות אלומיניום מתקדמים', 'מנכ"ל', 'שאהר אבו זייד', '04-9500900', 'orli@mateen.co.il');
    `, (insertErr) => {
      if (insertErr) {
        console.error('Error seeding employers:', insertErr.message);
      } else {
